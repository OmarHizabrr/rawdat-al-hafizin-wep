        ...
        <div className="space-y-6 pb-20">
            ...
            <div className="flex flex-col gap-4 rounded-2xl border border-border/70 bg-card/80 p-4 shadow-sm backdrop-blur-sm md:flex-row md:items-center md:justify-between md:p-6">
                <div className="relative z-10 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-black tracking-tight md:text-3xl">منارات المعرفة</h1>
                        <p className="text-[11px] text-muted-foreground md:text-xs">هندسة المسارات التعليمية وإدارة المحتوى الأكاديمي للدورات</p>
                    </div>
                </div>
                ...
                <div className="relative z-10 flex flex-col gap-3 md:flex-row">
                    ...
                    <button
                        onClick={handleAdd}
                        className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-primary px-6 text-sm font-black text-primary-foreground shadow-sm transition-colors hover:bg-primary/90"
                    >
